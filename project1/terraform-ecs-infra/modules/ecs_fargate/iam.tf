...
data "aws_iam_policy_document" "ecs_task_execute_cmd" {
   statement {
...
resource "aws_iam_policy" "ecs_task_execute_cmd" {
  name = "ecs_task_execute_cmd"
  path = "/"
  description = "Allow access to the service session manager"

  policy = data.aws_iam_policy_document.ecs_task_execute_cmd.json
}


resource "aws_iam_policy" "ecr_service" {
  name = "ecr-stage-policy"
  path = "/"
  description = "Allow standard ecr actions"
...
resource "aws_iam_role_policy_attachment" "ecr_service" {
  role = aws_iam_role.ecs_service.name
...
resource "aws_iam_role_policy_attachment" "ecs_task_execute_cmd" {
  role = aws_iam_role.ecs_service.name
  policy_arn = aws_iam_policy.ecs_task_execute_cmd.arn
}
